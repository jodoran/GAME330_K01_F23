...
namespace oldcodes
{
     ...
     */
    {
        ...
        private static OldGameManager _instance; // 내부
        public static OldGameManager Instance // 외부
        {
            get
            {
                ...
                {
                    _instance = FindObjectOfType<OldGameManager>();
                }
                return _instance;
            }
        }
        ...
        {   // 유닛 생성 함수
            ...
            OldUnit instantUnit = instant.GetComponent<OldUnit>();
        ...
        {
            OldUnit newUnit = GetUnits(); // 새로운 유닛 생성을 위해 겟유닛 함수 호출
